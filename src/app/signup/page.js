    ...
    <section className="min-h-screen bg-primary-gradient bg-[length:200%_200%] animate-gradientMove font-inter flex items-center justify-center p-4">
      <div className="max-w-xl w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
        ...
        <div className="bg-[#D5A581] p-8 text-center">
          ...
          <p className="text-gray-100 font-inter">Join us today</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={3}
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#D5A581] focus:border-transparent transition-all duration-200 font-inter resize-none ${
