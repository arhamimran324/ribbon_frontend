    ...
    <CheckboxPrimitive.Root
      ...
      className={cn(
        "peer border-input dark:bg-input/30 " +
          "data-[state=checked]:bg-[#d5a581] data-[state=checked]:text-white " +
          "data-[state=checked]:border-[#d5a581] " +
          ...
          "disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer", // 👈 added this
        className
      )}
      {...props}
    >
